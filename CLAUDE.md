...
- `index.html` — homepage/masthead
- `new-portfolio.html` — portfolio gallery
- `about.html`, `contact.html` — standard pages
- `pocket.html`, `amdocs-go-store.html`, `amdocs-outages.html`, `onetwofree.html` — project detail pages
...
- Images are served from Adobe's CDN (`cdn.myportfolio.com`) with responsive `srcset`
